...
import { quickRanges, snapBounds, snapValue, type QuickRange, type SliderBounds } from "./price-ranges";
...
function PriceForm({
  ...
  const onSlide = (v: number | readonly number[]) => {
    ...
    setValues([lo, hi]);
    setText([bounds && lo > bounds.lo ? String(lo) : "", bounds && hi < bounds.hi ? String(hi) : ""]);
  };
